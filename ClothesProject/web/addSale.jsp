<%-- 
    Document   : addSale
    Created on : Jul 14, 2023, 5:36:57 AM
    Author     : Pham Thang
--%>
        ...
        <div class="container ">
            ...
            <section class="panel panel-default">
                <div style="padding-bottom: 20px ;padding-top: 20px;" class="panel-heading"> 
                    <h3 class="panel-title">Add Sale<br> </h3> 
                </div> 
                <div class="panel-body">

                    <form action="addSale" class="form-horizontal" method="post" >
                        <div class="form-group row">
                            <label for="name" class="col-sm-3 control-label">Sale Name</label>
                            <div class="col-sm-3">
                                <input  required type="text" class="form-control" name="name" id="name" placeholder="Enter the sale name">
                            </div>
                            <label for="tech" class="col-sm-3 control-label">Apply</label>
                            <div class="col-sm-3">
                                <select name="apply" class="form-control">
                                    <option selected value="0">Not Apply</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input step="any"  required type="number"  class="form-control" name="sale" id="qty" placeholder="Enter Sale">
                            </div>
                        </div> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input  required type="datetime-local" class="form-control" name="from" id="qty">
                            </div>
                            <label for="qty" class="col-sm-3 control-label">To Date</label>
                            <div class="col-sm-3">
                                <input  required type="datetime-local" class="form-control" name="to" id="qty">
                            </div>
                        </div>
