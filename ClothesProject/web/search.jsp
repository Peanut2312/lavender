<%-- 
    Document   : search
    Created on : Jul 4, 2023, 5:59:44 PM
    Author     : Pham Thang
--%>
            ...
            <!--<div class="col-xs-12 col-md-6 bootstrap snippets bootdeys">
                    ...
                    <div class="product-content product-wrap clearfix">
                            <div class="row">
                                            <div class="col-md-5 col-sm-12 col-xs-12">
                                                    <div class="product-image"> 
                                                            <img src="https://www.bootdey.com/image/194x228/B0C4DE" alt="194x228" class="img-responsive"> 
                                                            <span class="tag2 hot">
                                                                    HOT
                                                            </span> 
                                                    </div>
            ...
            <!--<div class="col-xs-12 col-md-6 bootstrap snippets bootdeys">
                    ...
                    <div class="product-content product-wrap clearfix">
                            <div class="row">
                                            <div class="col-md-5 col-sm-12 col-xs-12">
                                                    <div class="product-image"> 
                                                            <img src="https://www.bootdey.com/image/194x228/D3D3D3" alt="194x228" class="img-responsive"> 
                                                            <span class="tag2 hot">
                                                                    HOT
                                                            </span> 
                                                    </div>
                ...
                <div class="col-xs-12 col-md-6 bootstrap snippets bootdeys">
                    ...
                    <div class="product-content product-wrap clearfix">
                        <div class="row">
                            <div class="col-md-5 col-sm-12 col-xs-12">
                                <div class="product-image"> 
                                    <img style="width: 276px" src="${p.image}" alt="194x228" class="img-responsive"> 
                                    <span class="tag2 hot">
                                        New
                                    </span> 
                                </div>
                                ...
                                <div class="product-deatil">
                                    <h5 class="name">
                                        <a href="product?productID=${p.productID}">
                                            ${p.name} <span>${p.sub_category.category.name}</span>
                                        </a>
                                    </h5>
                                    <p class="price-container">
                                        <span>${p.price}</span>
