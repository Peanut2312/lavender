<%-- 
    Document   : edit
    Created on : Jul 7, 2023, 6:56:36 PM
    Author     : Pham Thang
--%>
        ...
        <div class="container ">
            ...
            <section class="panel panel-default">
                <div style="padding-bottom: 20px ;padding-top: 20px;" class="panel-heading"> 
                    <h3 class="panel-title">Edit Product<br> </h3> 
                </div> 
                <div class="panel-body">
                    ...
                    <form action="edit" class="form-horizontal" method="post" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input value="${p.name}" required type="text" class="form-control" name="name" id="name" placeholder="Enter the product name">
                            </div>
                        </div> <!-- form-group // -->
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select name="brand" class="form-control">
                                    <c:forEach items="${requestScope.listBrand}" var="b">
                                        <option ${b.brandID == p.brand.brandID ? "selected" : ""} value="${b.brandID}">${b.name}</option>
                                    </c:forEach>
                            ...
                            <div class="col-sm-3">
                                <select name="sub" class="form-control">
                                    <c:forEach items="${requestScope.listSub}" var="s">
                                        <option ${s.subID == p.sub_category.subID ? "selected" : ""} value="${s.subID}">${s.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input value="${p.price}" pattern="\d+" required type="text" class="form-control" name="price" id="qty" placeholder="Enter Price">
                            </div>
                            <label for="qty" class="col-sm-3 control-label">Create Date</label>
                            <div class="col-sm-3">
                                <input value="${p.createDate}" required type="date" class="form-control" name="date" id="qty">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input value="${p.material}" required type="text" class="form-control" name="material" id="name" placeholder="Enter Material">
                            </div>
                        </div> <!-- form-group // -->
                        <div class="form-group row">
                            <label for="about" class="col-sm-3 control-label">Detail</label>
                            <div class="col-sm-9">
                                <textarea id="ck"  required  name="name" class="form-control">${p.detail}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea  required name="guide" class="form-control">${p.sizeGuide}</textarea>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea  required name="refund" class="form-control">${p.refundPolicy}</textarea>
                            </div>
                        </div><!-- form-group // -->
                        <!-- form-group // -->
                        <!-- form-group // -->
